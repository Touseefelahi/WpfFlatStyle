...
namespace FlatStyle.Controls
{
    ...
    public partial class ColorPickerControl : UserControl
    {
        ...
        public ColorPickerControl(Color initialColor)
        {
            InitializeComponent();
        ...
        private void AlphaSlider_ValueChanged(object sender, RoutedPropertyChangedEventArgs<double> e)
        {
            ...
            ColorDisplay.Background = new SolidColorBrush(SelectedColor);
        }
        ...
        {
            txtAlpha.Text = $"{SelectedColor.A},{SelectedColor.A.ToString("X2")}";
            txtRed.Text = $"{SelectedColor.R},{SelectedColor.R.ToString("X2")}";
            txtGreen.Text = $"{SelectedColor.G},{SelectedColor.G.ToString("X2")}";
            txtBlue.Text = $"{SelectedColor.B},{SelectedColor.B.ToString("X2")}";
            txtAll.Text = String.Format("#{0}{1}{2}{3}", SelectedColor.A.ToString("X2"), SelectedColor.R.ToString("X2"),
              SelectedColor.G.ToString("X2"), SelectedColor.B.ToString("X2"));
        }
